    ...
    <div class="container m-auto">
        <div class="side-bar-section shadow d-none d-md-block">
            <div class="flex justify-between bg-white">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-4 xl:grid-cols-3 mt-5 justify-center items-center w-full px-5 py-16 gap-5">
                    <div class="member-list col-span-1 sm:col-span-1 md:col-span-2 lg:col-span-2 xl:col-span-1 border shadow oversight-plan-link flex h-auto gap-5 py-3">
                        ...
                        <div class="member-list-text w-full sm:w-[80%] md:w-[80%] lg:w-[80%] xl:w-[80%] my-3">
                            <h6>UNOPS Programmatic updates presentaiton_Jan-Jun 2021</h6>
